...
1. 프로젝트 소개 — 무엇을 만드는가
2. 요구사항 작성하기 — AI-Native 개발의 첫 단계
3. 프로젝트 구조 만들기 — 폴더와 파일 준비
4. 핵심 로직부터 — 테스트 먼저 — 미니 TDD 경험
5. UI 연결하기 — DOM 코드 읽고 검증
6. 검증하고 개선하기 — 엣지 케이스 테스트
7. Phase 2 관문 — 자기 점검 체크리스트
8. 정리 — Phase 2 완주 축하
