...
2. TDD 실습 1: 문자열 유틸리티 — Red-Green-Refactor 첫 경험
3. TDD 실습 2: 장바구니 기능 — 복잡한 로직에 TDD 적용
4. Custom Agent란? — 전문가 역할 부여하기
5. Agent 사용하기 — 실전 워크플로우
6. 실습 과제 — 기본 / 도전
7. 정리 — 핵심 요약 및 다음 장
