...
| 장 | 제목                                             | 핵심 내용                                   |
| -- | ------------------------------------------------ | ------------------------------------------- |
| 00 | 프로그래밍이란? + 환경 구축  | 프로그래밍 개념, VS Code + Node.js 설치     |
| 01 | 첫 번째 웹페이지 만들기 | HTML + JS 맛보기, 버튼 클릭으로 글자 바꾸기 |
...
| 장 | 제목                                                   | 핵심 내용                                |
| -- | ------------------------------------------------------ | ---------------------------------------- |
| 02 | 변수와 데이터 타입             | let/const, string/number/boolean, typeof |
| 03 | 조건문                      | if/else, switch, 비교 연산자             |
| 04 | 반복문과 배열                      | for, while, 배열 기본                    |
| 05 | 함수                           | 선언, 매개변수, 반환값, 화살표 함수      |
| 06 | 객체와 배열 심화                 | 객체, 구조분해, map/filter               |
| 07 | 테스트 입문 + AI 도구 설정 | Vitest 첫 경험, GitHub Copilot 설치      |
...
| 장 | 제목                                                  | 핵심 내용                             |
| -- | ----------------------------------------------------- | ------------------------------------- |
| 08 | DOM과 이벤트                        | AI 생성 DOM 코드 읽기/수정            |
| 09 | AI 출력 평가법 — Bug Hunt     | 의도적 버그 찾기, AI 코드 비판적 평가 |
| 10 | 비동기 JavaScript                 | fetch, async/await, API 호출          |
| 11 | 미니 프로젝트: AI 협업 ToDo 앱 | 요구사항 → AI 생성 → 테스트 → 수정 |
...
| 장 | 제목                                                     | 핵심 내용                                 |
| -- | -------------------------------------------------------- | ----------------------------------------- |
| 12 | Custom Instructions           | AI에게 프로젝트 규칙 알려주기             |
| 13 | Prompt Files + Context Engineering | 반복 작업 템플릿, 맥락 설계               |
| 14 | Custom Agent                         | AI에게 전문가 역할 부여                   |
| 15 | TDD                                    | 요구사항 → 테스트 → AI 구현              |
| 16 | 통합 프로젝트: 날씨 앱         | 전체 AI-Native 파이프라인                 |
| 17 | 통합 프로젝트: 영화 검색 앱      | 독립 AI-Native 실행 (선택형 캡스톤) |
