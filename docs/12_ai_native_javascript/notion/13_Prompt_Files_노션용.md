...
1. Prompt File이란? — "단골 주문서" 비유
2. 첫 Prompt File 만들기 — new-feature.prompt.md
3. 더 많은 Prompt Files — 테스트, 디버그, 리뷰 템플릿
4. Context Engineering — AI에게 맥락 꾸러미 전달하기
5. 좋은 프롬프트 vs 나쁜 프롬프트 — 비교와 개선
6. 실습 과제 — 기본 / 도전
7. 정리 — 핵심 요약 및 다음 장
...
## 4️⃣ 📖 **더 알아보기** — Context Engineering
...
→ **다음 장**: 14. Custom Agent — AI에게 전문가 역할 부여
{% endraw %}
