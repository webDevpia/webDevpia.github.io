...
1. DOM이란? — HTML의 가계도(트리)
2. 요소 선택하기 — getElementById, querySelector, querySelectorAll
3. 요소 변경하기 — textContent, innerHTML, style, classList
4. 이벤트 리스너 — addEventListener 패턴
5. AI가 생성한 DOM 코드 읽기 — 한 줄씩 설명하기
6. 실습 과제 — 기본 / 도전
7. 정리 — 핵심 요약 및 다음 장
