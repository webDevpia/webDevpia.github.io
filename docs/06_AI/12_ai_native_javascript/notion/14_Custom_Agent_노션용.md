...
1. Custom Agent란? — 전문가 역할 부여하기
2. Agent 파일 작성하기 — tdd-agent.md 만들기
3. Agent 사용하기 — 실전 워크플로우
4. 실습 과제 — 기본 / 도전
5. 정리 — 핵심 요약 및 다음 장
...
→ **다음 장**: 15. TDD — 요구사항으로 테스트하고 AI가 구현한다
{% endraw %}
