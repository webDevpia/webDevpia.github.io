---
title: 0. Linear Regression
layout: default
parent: DeepLearning
nav_order: 0
permalink: /DeepLearning/linearRegression
# nav_exclude: true
# search_exclude: true
---
...
1. [지도학습 개요 — 회귀 vs 분류](#part1)
2. [선형 회귀 — 직선으로 미래를 예측하기](#part2)
3. [손실 함수 — 얼마나 틀렸는지 측정하기](#part3)
4. [경사하강법 — 최적의 W, b 찾기](#part4)
5. [Python으로 단순 선형 회귀 구현](#part5)
6. [다변수 선형 회귀 (Multi-variable)](#part6)
7. [로지스틱 회귀 — 분류 문제 풀기](#part7)
8. [정리 + XOR 문제 복선](#part8)
...
```python
np.random.seed(42)
W = np.random.rand(1, 1)  # 가중치 (1x1 행렬) ,0 이상 1 미만의 균등분포 난수
...
## 6. 다변수 선형 회귀 (Multi-variable) [↑](#toc)
...
→ **다음 장**: [1. PyTorch 기본 사용법](/deeplearning/PyTorch)
