...
parent: HTML
nav_order: 1
permalink: /language/html/getting-started
---
...
1. [HTML이란?](#part1) — 웹에서의 역할과 HTML·CSS·JS 비교
2. [첫 HTML 파일 만들기](#part2) — VSCode, Live Server, 기본 구조
3. [텍스트 태그](#part3) — 제목, 문단, 강조
4. [링크와 이미지](#part4) — `<a>`, `<img>`, alt 속성
5. [목록](#part5) — 순서 있는 목록, 순서 없는 목록, 중첩
6. [실습: 나의 첫 웹페이지 완성](#part6) — 배운 태그 전부 활용
7. [정리](#part7) — 태그 요약 표, 다음 장 미리보기, 실습 과제
...
<!-- 같은 페이지 내 이동 (id가 "intro"인 요소로 스크롤) -->
<a href="#intro">소개 섹션으로 이동</a>
<!-- 대상 요소에 id를 지정: <h2 id="intro">소개</h2> -->

<!-- 다른 HTML 파일로 이동 -->
<a href="about.html">소개 페이지</a>

<p></p>
<img src=" https://placehold.co/800x1200" alt="">
<h2 id="intro">소개</h2>
<img src=" https://placehold.co/800x1200" alt="">
...
```html
<!-- 인터넷 이미지 -->
<img src="https://placehold.co/300x200" alt="300x200 플레이스홀더 이미지">
...
<a href="https://www.google.com" target="_blank">
    <img src="https://placehold.co/150" alt="구글로 이동">
</a>
```
...
<body>
    ...
    <h2>프로필 이미지</h2>
    <img src="https://placehold.co/200x200" alt="김코딩의 프로필 사진">
