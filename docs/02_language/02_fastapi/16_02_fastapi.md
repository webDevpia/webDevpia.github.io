...
![](./img/fastapi005.png){: width="600" height="auto" }
...
여러 개의 input 값들을 한번에 처리할 수도 있지만, 이를 위해서는 Form()과 Pydantic을 classmethod로 결합해야 함  
 ...
 ![](./img/fastapi006.png){: width="500" height="auto" }

 ![](./img/fastapi007.png){: width="600" height="auto" }
...
FastAPI의 Request 객체는 HTTP Request에 대한 대부분의 정보를 다 가지고 있음. 
 ...
 ![](./img/fastapi008.png){: width="400" height="auto" }

 ![](./img/fastapi009.png){: width="500" height="auto" }
