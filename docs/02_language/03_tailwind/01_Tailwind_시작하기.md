---
title: 01. Tailwind CSS 시작하기
layout: default
grand_parent: Language
parent: Tailwind CSS
nav_order: 1
permalink: /language/tailwind/getting-started
---
...
1. [Tailwind CSS란?](#part1) — 유틸리티 클래스 개념과 등장 배경
2. [CDN으로 시작하기](#part2) — v4 CDN 설정과 첫 실습
3. [CSS ↔ Tailwind 대응표](#part3) — 핵심 클래스 1:1 매핑
4. [색상 시스템](#part4) — 팔레트와 농도 체계
5. [hover, focus, 상태 클래스](#part5) — 인터랙티브 스타일링
6. [실용 예제: 카드 레이아웃 변환](#part6) — Before/After 비교
7. [정리](#part7) — 치트시트와 실습 과제

---

<a id="part1"></a>

## 1️⃣ Tailwind CSS란? [↑](#toc)
...
## 6️⃣ 실용 예제: CSS 카드 레이아웃을 Tailwind로 변환 [↑](#toc)
