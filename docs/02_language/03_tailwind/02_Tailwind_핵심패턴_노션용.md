...
1. Position과 Z-index — 무대 위 배우처럼 위치 제어
2. Display와 Visibility — 가구를 없애거나 투명 망토 씌우기
3. 테두리, 그림자, Ring — 액자와 그림자로 요소 강조
4. Group Hover와 Peer — 부모가 반응하면 자식도 따라 반응
5. Transition과 Animation — 부드러운 움직임 만들기
6. 임의값과 공식 문서 활용 — 스케일 밖의 값, 문서 검색법
7. 정리 — 핵심 요약과 실습 과제

---

## 1️⃣ Position과 Z-index
