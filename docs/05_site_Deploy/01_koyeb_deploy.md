...
![](./img/koyeb/koyeb01.png)

### 2. "SIGN UP WITH GITHUB" 클릭  
![](./img/koyeb/koyeb02.png)

### 3. github 계정으로 로그인  
![](./img/koyeb/koyeb03.png)

### 4. "Authorize Koyeb" 클릭  
![](./img/koyeb/koyeb04.png)

### 5. Organization 이름 입력 후 설문 내용 기입  
![](./img/koyeb/koyeb05.png)

### 6. 가입완료 후 기본 화면으로 이동된다.
![](./img/koyeb/koyeb06.png)

### 7. "Apps" 클릭하고, "Create App +" 버튼 클릭  
![](./img/koyeb/koyeb07.png)

### 8. "GitHub" 선택  
![](./img/koyeb/koyeb08.png)

### 9. "install GitHub App" 클릭  
![](./img/koyeb/koyeb09.png)

### 10 "install" 클릭  
![](./img/koyeb/koyeb10.png)

### 11. 배포할 repository 선택  
![](./img/koyeb/koyeb11.png)

### 12. 브랜치 선택
![](./img/koyeb/koyeb12.png)

### 13. app name 입력
![](./img/koyeb/koyeb13.png)

### 14. "Build and deployment settings" 클릭하고 Run command 내용 입력
![](./img/koyeb/koyeb14.png)

### 15. "Advanced" 클릭, 환경변수 등 필요한 내용 추가  
![](./img/koyeb/koyeb15.png)

### 16. "Deploy" 버튼 클릭

배포가 진행되고 완료되면 service가 healthy 상태가 되면 성공.
![](./img/koyeb/koyeb16.png)

### 17. Overview에서 Log를 확인해 본다.
![](./img/koyeb/koyeb17.png)

![](./img/koyeb/koyeb18.png)
![](./img/koyeb/koyeb19.png)