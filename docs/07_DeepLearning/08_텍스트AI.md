...
# search_exclude: true
---
# 9. 텍스트 AI 기초 - 텍스트를 숫자로 바꾸는 법부터 GPT(Generative Pre-trained Transformer)까지

> 이 자료는 코드 실습 없이, 비전공자가 **텍스트 AI의 큰 흐름**을 이해하도록 돕는 개념 노트입니다.
> 목표는 "무엇이 왜 등장했고, 무엇을 해결했고, 어디서 오해하기 쉬운가"를 잡는 것입니다.
