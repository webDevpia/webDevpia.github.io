...
1. [입문자가 자주 하는 오해](#1-입문자가-자주-하는-오해)
2. [MNIST로 모델 학습해보기](#2-mnist로-모델-학습해보기)
3. [퍼셉트론과 인공신경망 기초](#3-퍼셉트론과-인공신경망-기초)
4. [MLP(다층 퍼셉트론) 구조](#4-mlp다층-퍼셉트론-구조)
5. [활성화함수 진화사 (Sigmoid -> ReLU -> GELU)](#5-활성화함수-진화사-sigmoid---relu---gelu)
6. [활성화함수 비교 실험](#6-활성화-함수-비교-실험)

## [1. 입문자가 자주 하는 오해](#진행순서)
...
## [5. 활성화함수 진화사 (Sigmoid -> ReLU -> GELU)](#진행순서)
