---
title: indexing with metada
layout: default
grand_parent: LLM
parent: RagRetrieval
nav_order: 7
permalink: /ragretrieval/indexing
# nav_exclude: true
# search_exclude: true
--- 
...
[documents_meta.csv](./data/documents_meta.csv)
...
* `from langchain_core.documents import Document`를 통해 LangChain의 Document 클래스(구조)를 임포트합니다.
