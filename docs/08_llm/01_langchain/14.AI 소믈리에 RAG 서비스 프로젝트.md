...
1. [프로젝트 개요](#1-프로젝트-개요) - AI 소믈리에 서비스 기획
2. [서비스 시나리오](#2-서비스-시나리오) - 사용자 흐름 설계
3. [시스템 아키텍처](#3-시스템-아키텍처) - RAG 파이프라인 구성
4. [주요 사용 기술 및 환경](#4-주요-사용-기술-및-환경) - 기술 스택 정리
5. [step1](#step1) - 와인 데이터 임베딩 및 검색 구현
6. [step2](#step2) - 음식 추천/묘사 체인 구현
7. [프로젝트 완성 및 배포](#프로젝트-완성-및-배포) - Streamlit 앱 완성
