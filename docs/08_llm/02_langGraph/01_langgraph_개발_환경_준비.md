...
- **배경 및 등장:** Autogen, CrewAI 등 다양한 멀티 에이전트 프레임워크가 등장하는 가운데, LangChain 팀은 LangGraph를 통해 **그래프 기반 멀티 에이전트 워크플로우**의 이점을 강조했습니다. 이는 **유연한 흐름 제어**와 **공유 상태 관리**를 지원하여 기존 연속 실행 방식의 한계를 보완합니다.
