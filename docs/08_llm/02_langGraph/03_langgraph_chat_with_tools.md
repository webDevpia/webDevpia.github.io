---
title: 3. LangGraph 챗봇에서 도구 사용하기
layout: default
grand_parent: LLM
parent: LangGraph
nav_order: 3
permalink: /llm/langgraph/chat_tool_1
# nav_exclude: true
# search_exclude: true
--- 
...
가입시 default로 기본 Api key가 있음.(default key 사용, 재발급시 사용하기까지 일정 시간지나야 사용 가능.) 
...
- `llm`: 사용되는 LLM 모델로, 여기서는 OpenAI의 gpt-4.1-nano 모델을 사용합니다.
