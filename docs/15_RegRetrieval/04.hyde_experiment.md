---
title: HyDE (Hypothetical Document Embedding) 실험
layout: default
parent: RagRetrieval
nav_order: 4
permalink: /ragretrieval/hyde
# nav_exclude: true
# search_exclude: true
--- 
...
tokenized_docs = [mecab.parse(content).strip().split() for content in documents_df['content']]
bm25 = BM25Okapi(tokenized_docs)
