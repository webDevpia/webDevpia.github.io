...
| 교시 | 장 | 주제 | 형태 | 핵심 성취 |
|------|---|------|------|-----------|
| 1교시 | **HTML 01장** | HTML 시작하기 — 태그, 문서 구조, 텍스트, 링크, 이미지 | 강의+실습 | ✅ 첫 HTML 파일 작성 |
| 2교시 | **HTML 01장** | 목록, 테이블 + 실습 확장 | 강의+실습 | ✅ HTML 기본 태그 습득 |
...
| 8교시 | | **회고** — 오늘 배운 것 정리, 산출물 공유, Q&A | 회고 | |
...
| 교시 | 장 | 주제 | 형태 | 핵심 성취 |
|------|---|------|------|-----------|
| 1교시 | **CSS 02장** | Flexbox — 주축/교차축, justify-content, align-items | 강의+실습 | ✅ Flexbox 레이아웃 |
| 2교시 | **CSS 03장** | 반응형 디자인 — 미디어 쿼리 개념 + 반응형 유닛 | 강의+실습 | ✅ 반응형 개념 이해 |
| 3교시 | **Tailwind 01장** | Tailwind CSS 시작하기 — CDN, 유틸리티 클래스, 색상, hover | 강의+실습 | ✅ Tailwind 첫 체험 |
| 4교시 | **Tailwind 01장** | Tailwind 반응형(sm/md/lg) + Flexbox 조합 | 실습 | ✅ 반응형 카드 완성 |
| 점심 | | | | |
| 5교시 | **Tailwind 03장** | 미니 프로젝트: Tailwind 랜딩 페이지 (Part 1) — Hero + 네비게이션 | **실습** | ✅ Hero 섹션 완성 |
| 6교시 | **Tailwind 03장** | 미니 프로젝트: 랜딩 페이지 (Part 2) — 특징 카드 + 푸터 | **실습** | ✅ 랜딩 페이지 완성 |
| 7교시 | **Tailwind 03장** | 랜딩 페이지 개인 커스터마이징 + 완성도 높이기 | **실습** | ✅ 나만의 스타일 적용 |
| 8교시 | | **회고** — 산출물 공유, "내가 만든 웹사이트" 자랑, Q&A | 회고 | |
...
| 교시 | 장 | 주제 | 형태 | 핵심 성취 |
|------|---|------|------|-----------|
| 1교시 | **JS 04장** | 반복문과 배열 — for, while, 배열 기본 | 강의+실습 | ✅ for문 작성 가능 |
| 2교시 | **JS 06장** | 객체와 배열 심화 — 객체, map/filter (핵심만) | 강의+실습 | ✅ 객체 개념 이해 |
| 3교시 | **JS 07장** | GitHub Copilot 설치 + Vitest 첫 경험 | 실습 | ✅ Copilot 작동 확인 |
| 4교시 | **JS 09장** | AI 출력 평가법 — Bug Hunt 게임 (Level 1-2) | 실습 | ✅ AI 코드에서 버그 발견 |
| 점심 | | | | |
| 5교시 | **JS 09장** | Bug Hunt 게임 (Level 3) + "Explain It Back" | 실습 | ✅ AI 코드 설명 가능 |
| 6교시 | | 미니 프로젝트: 인터랙티브 퀴즈 게임 (Part 1) | **실습** | ✅ 퀴즈 로직 구현 |
| 7교시 | | 미니 프로젝트: 퀴즈 게임 (Part 2) + 완성 | **실습** | ✅ 퀴즈 게임 완성 |
| 8교시 | | **회고** — Bug Hunt 팀 대결, 산출물 공유, Q&A | 회고 | |
...
| 7교시 | **JS 11장** | ToDo 앱 마무리 + 교차 테스트 (팀 간 앱 테스트) | **실습** | ✅ ToDo 앱 완성 |
| 8교시 | | **회고** — Phase 2 관문 체크리스트, 산출물 공유, Q&A | 회고 | |
...
| 4교시 | **JS 14장** | TDD + AI 에이전트 — Red-Green-Refactor (맛보기) | 실습 | ✅ TDD 사이클 체험 |
| 점심 | | | | |
...
| 8교시 | | **회고** — 날씨 앱 공유, 캡스톤 안내, TMDB API 키 발급 안내, Q&A | 회고 | |
...
| 교시 | 장 | 주제 | 형태 | 핵심 성취 |
|------|---|------|------|-----------|
| 1교시 | **JS 15장 or 16장** | 주제 선택 후 프로젝트 구현 — 스프린트 1 | 실습 | ✅ 핵심 기능 구현 |
| 2교시 | | 프로젝트 구현 — 스프린트 2 (기능 확장 + 스타일링) | 실습 | ✅ UI 완성도 |
| 3교시 | | 프로젝트 구현 — 스프린트 3 (테스트 + 마무리) | 실습 | ✅ 최종 산출물 완성 |
| 4교시 | | 프로젝트 교차 테스트 + 발표 준비 | 실습 | |
| 점심 | | | | |
| 5교시 | | **최종 발표** (전반) — 팀당 10분 시연 + 5분 Q&A | 발표 | ✅ 프로젝트 시연 |
| 6교시 | | **최종 발표** (후반) + 시상 | 발표 | |
| 7교시 | | AI 윤리 토론 + 커리어 로드맵 | 토론 | |
| 8교시 | | **최종 회고** — 7일 전체 돌아보기, 네트워킹, 수료식 | 회고+수료 | |
